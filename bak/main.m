...
R_vb = quat2dcm(quat_vicon(ind_align_vicon,:));% body in vicon
R_rb = quat2dcm(quat_rovio(ind_align_rovio,:));% body in rovio world.
...
% check, this check seems nonsense to me, see equation above!
